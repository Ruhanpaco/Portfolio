...
const TechTag = ({ name, icon, color }: { name: string; icon: React.ReactNode; color?: string }) => (
    <div className="flex items-center gap-1.5 px-2.5 py-1 rounded-md bg-foreground/5 border border-foreground/5 text-xs font-medium text-foreground/80 hover:bg-foreground/10 hover:text-foreground transition-all">
        ...
        <section className="mt-32 md:mt-48">
            <div className="mb-10">
                ...
                <p className="mt-3 text-base text-foreground/60 max-w-2xl">
                    A comprehensive list of technologies and tools I use.
                </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-8 gap-y-12">
                ...
                <div className="space-y-4">
                    <h3 className="text-sm font-semibold tracking-wide text-foreground border-b border-foreground/10 pb-2">Frontend</h3>
                ...
                {/* Backend & APIs */}
                <div className="space-y-4">
                    <h3 className="text-sm font-semibold tracking-wide text-foreground border-b border-foreground/10 pb-2">Backend & APIs</h3>
                    <div className="flex flex-wrap gap-2">
                ...
                {/* Databases */}
                <div className="space-y-4">
                    <h3 className="text-sm font-semibold tracking-wide text-foreground border-b border-foreground/10 pb-2">Databases</h3>
                    <div className="flex flex-wrap gap-2">
                ...
                {/* Cloud & DevOps */}
                <div className="space-y-4">
                    <h3 className="text-sm font-semibold tracking-wide text-foreground border-b border-foreground/10 pb-2">Cloud & DevOps</h3>
                    <div className="flex flex-wrap gap-2">
                ...
                {/* Tools & Software */}
                <div className="space-y-4">
                    <h3 className="text-sm font-semibold tracking-wide text-foreground border-b border-foreground/10 pb-2">Tools & Software</h3>
                    <div className="flex flex-wrap gap-2">
